...
alias brg="batgrep" # obsolete, use rg (ripgrep)
alias du='du -kh'
...
# Specific dotfiles git repo alias | obsolete, use `chezmoi`
...
# Home dir version control
alias c='chezmoi'
alias cst='chezmoi status'
alias cdiff='chezmoi diff'
alias cun='chezmoi unmanaged'
alias cadd='chezmoi add'
alias cread='chezmoi re-add'
